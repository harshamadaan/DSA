...
class Solution {
    ...
    public List<List<Integer>> zigzagLevelOrder(TreeNode root) {
        ...
        List<List<Integer>> ans=new ArrayList<>(); //jisko muja return krava h final array list jiska andr arr hoga
        if(root==null) return ans;
        for(int i=1;i<=level;i++){
            List<Integer> arr=new ArrayList<>();  //print nhi krvana hma array bnana h
